...
$string['ai_response'] = 'Resposta da IA';
$string['ai_response_approved'] = 'Resposta da IA Aprovada';
$string['ai_response_proposed'] = 'Resposta da IA Proposta';
$string['ai_response_rejected'] = 'Resposta da IA Rejeitada';
$string['aiproposed'] = 'Resposta da IA Proposta';
...
$string['datacurso_custom'] = 'Fórum IA Datacurso';
$string['default_reply_message'] = 'Responder com tom empático e motivador';
...
$string['pendingresponses'] = 'Respostas IA do Fórum Pendentes';
$string['pluginname'] = 'Fórum IA';
$string['preview'] = 'Mensagem IA';
$string['reject'] = 'Rejeitar';
$string['reply_message'] = 'Dar instruções para a IA';
$string['replylevel'] = 'Resposta nível {$a}';
$string['require_approval'] = 'Verificar resposta da IA';
