...
$string['nopermission'] = 'Você não tem permissão para aprovar/rejeitar respostas IA.';
...
$string['privacy:metadata:local_forum_ai_config:forumid'] = 'O ID do fórum ao qual esta configuração pertence.';
$string['privacy:metadata:local_forum_ai_config:reply_message'] = 'Modelo de resposta gerada pela IA.';
$string['privacy:metadata:local_forum_ai_config:require_approval'] = 'Indica se as respostas de IA exigem aprovação antes de serem publicadas.';
...
$string['privacy:metadata:local_forum_ai_pending:approval_token'] = 'Token de aprovação vinculado à postagem.';
$string['privacy:metadata:local_forum_ai_pending:approved_at'] = 'Data que a resposta foi aprovada.';
$string['privacy:metadata:local_forum_ai_pending:creator_userid'] = 'ID do usuário que criou a postagem.';
$string['privacy:metadata:local_forum_ai_pending:discussionid'] = 'ID da discussão relacionada.';
$string['privacy:metadata:local_forum_ai_pending:forumid'] = 'ID do fórum no qual a resposta foi gerada.';
$string['privacy:metadata:local_forum_ai_pending:message'] = 'Mensagem gerada pela inteligência artificial.';
$string['privacy:metadata:local_forum_ai_pending:status'] = 'Estado da postagem (aprovada, pendente ou rejeitada).';
$string['privacy:metadata:local_forum_ai_pending:subject'] = 'Assunto ou tema da mensagem.';
$string['privacy:metadata:local_forum_ai_pending:timecreated'] = 'Data que o registro foi criado.';
$string['privacy:metadata:local_forum_ai_pending:timemodified'] = 'Data que o registro foi atualizado.';
$string['reject'] = 'Rejeitar';
$string['reply_message'] = 'Dê instruções à IA';
$string['replylevel'] = 'Nível de resposta {$a}';
$string['require_approval'] = 'Exigir revisão de IA';
