...
$string['privacy:metadata:local_forum_ai'] = 'Datos almacenados por el plugin Foro IA.';
$string['privacy:metadata:local_forum_ai:approval_token'] = 'Token de aprobación vinculado a la publicación.';
$string['privacy:metadata:local_forum_ai:approved_at'] = 'Fecha en la que fue aprobada la respuesta.';
$string['privacy:metadata:local_forum_ai:creator_userid'] = 'ID del usuario que creó la publicación.';
$string['privacy:metadata:local_forum_ai:discussionid'] = 'ID de la discusión relacionada.';
$string['privacy:metadata:local_forum_ai:forumid'] = 'ID del foro en el que se generó la respuesta.';
$string['privacy:metadata:local_forum_ai:message'] = 'Mensaje generado por la inteligencia artificial.';
$string['privacy:metadata:local_forum_ai:status'] = 'Estado de la publicación (aprobada, pendiente o rechazada).';
$string['privacy:metadata:local_forum_ai:subject'] = 'Asunto o tema del mensaje.';
$string['privacy:metadata:local_forum_ai:timecreated'] = 'Fecha en que se creó el registro.';
$string['privacy:metadata:local_forum_ai:timemodified'] = 'Fecha en que se actualizó el registro.';
