...
$string['discussionmsg'] = 'Message créé par l’IA';
...
$string['nopermission'] = 'Vous n’avez pas la permission d’approuver/rejeter des réponses IA.';
$string['noresponses'] = 'Il n’y a pas de réponses en attente d’approbation.';
...
$string['privacy:metadata:local_forum_ai_config:reply_message'] = 'Modèle de réponse générée par l’IA.';
$string['privacy:metadata:local_forum_ai_config:require_approval'] = 'Indique si les réponses de l’IA nécessitent une approbation avant publication.';
$string['privacy:metadata:local_forum_ai_config:timecreated'] = 'Date de création de la configuration.';
$string['privacy:metadata:local_forum_ai_config:timemodified'] = 'Date de la dernière modification de la configuration.';
$string['privacy:metadata:local_forum_ai_pending'] = 'Données stockées par le plugin Forum IA.';
$string['privacy:metadata:local_forum_ai_pending:approval_token'] = 'Jeton d’approbation lié au message.';
$string['privacy:metadata:local_forum_ai_pending:approved_at'] = 'Date à laquelle la réponse a été approuvée.';
$string['privacy:metadata:local_forum_ai_pending:creator_userid'] = 'ID de l’utilisateur qui a créé le message.';
$string['privacy:metadata:local_forum_ai_pending:discussionid'] = 'ID de la discussion associée.';
$string['privacy:metadata:local_forum_ai_pending:forumid'] = 'ID du forum dans lequel la réponse a été générée.';
$string['privacy:metadata:local_forum_ai_pending:message'] = 'Message généré par intelligence artificielle.';
$string['privacy:metadata:local_forum_ai_pending:status'] = 'Statut du message (approuvé, en attente ou rejeté).';
...
$string['reply_message'] = 'Donne des instructions à l’IA';
$string['replylevel'] = 'Niveau de réponse {$a}';
$string['require_approval'] = 'Requérir une révision IA';
