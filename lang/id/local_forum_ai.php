...
$string['ai_response_proposed'] = 'Respon AI yang Diusulkan';
$string['ai_response_rejected'] = 'Respon AI Ditolak';
$string['aiproposed'] = 'Respon AI yang Diusulkan';
...
$string['default_reply_message'] = 'Jawab dengan nada empatik dan memotivasi';
$string['discussion'] = 'Diskusi';
$string['discussion_label'] = 'Diskusi: {$a}';
$string['discussioninfo'] = 'Informasi diskusi';
$string['discussionmsg'] = 'Pesan dibuat oleh AI';
...
$string['nopermission'] = 'Anda tidak memiliki izin untuk menyetujui/menolak respon AI.';
$string['noresponses'] = 'Tidak ada respon yang menunggu persetujuan.';
$string['originalmessage'] = 'Pesan asli';
$string['pendingresponses'] = 'Respon Forum AI Tertunda';
$string['pluginname'] = 'Forum AI';
$string['preview'] = 'Pesan AI';
$string['reject'] = 'Tolak';
$string['reply_message'] = 'Berikan arahan kepada AI';
$string['replylevel'] = 'Respon tingkat {$a}';
$string['require_approval'] = 'Periksa respon AI';
