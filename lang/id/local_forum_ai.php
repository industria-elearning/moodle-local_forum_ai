...
$string['ai_response_proposed'] = 'Respons AI Diusulkan';
$string['ai_response_rejected'] = 'Respons AI Ditolak';
$string['aiproposed'] = 'Respons AI diusulkan';
...
$string['no'] = 'Tidak';
$string['no_posts'] = 'Tidak ada pos ditemukan dalam diskusi ini.';
...
$string['pendingresponses'] = 'Respons AI Forum Menunggu';
$string['pluginname'] = 'Forum AI';
$string['preview'] = 'Pesan AI';
$string['privacy:metadata:local_forum_ai_config'] = 'Menyimpan pengaturan AI per forum.';
$string['privacy:metadata:local_forum_ai_config:enabled'] = 'Menunjukkan apakah AI diaktifkan untuk forum ini.';
$string['privacy:metadata:local_forum_ai_config:forumid'] = 'ID forum yang dikaitkan dengan konfigurasi ini.';
$string['privacy:metadata:local_forum_ai_config:reply_message'] = 'Template respons yang dibuat oleh AI.';
...
$string['privacy:metadata:local_forum_ai_pending:approval_token'] = 'Token persetujuan terkait posting.';
$string['privacy:metadata:local_forum_ai_pending:approved_at'] = 'Tanggal respons disetujui.';
...
$string['privacy:metadata:local_forum_ai_pending:forumid'] = 'ID forum di mana respons dibuat.';
...
$string['privacy:metadata:local_forum_ai_pending:subject'] = 'Subjek atau topik pesan.';
$string['privacy:metadata:local_forum_ai_pending:timecreated'] = 'Tanggal catatan dibuat.';
$string['privacy:metadata:local_forum_ai_pending:timemodified'] = 'Tanggal catatan diperbarui.';
$string['reject'] = 'Tolak';
$string['reply_message'] = 'Berikan instruksi ke AI';
$string['replylevel'] = 'Tingkat respons {$a}';
$string['require_approval'] = 'Memerlukan tinjauan AI';
