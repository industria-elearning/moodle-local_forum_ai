...
$string['default_reply_message'] = 'Antworten Sie mit einem empathischen und motivierenden Ton';
...
$string['nopermission'] = 'Sie haben keine Berechtigung, KI-Antworten zu genehmigen/ablehnen.';
$string['noresponses'] = 'Es sind keine Genehmigungen ausstehend.';
...
$string['privacy:metadata:local_forum_ai_config'] = 'Speichert KI-Einstellungen pro Forum.';
$string['privacy:metadata:local_forum_ai_config:enabled'] = 'Gibt an, ob KI für dieses Forum aktiviert ist.';
$string['privacy:metadata:local_forum_ai_config:forumid'] = 'Die Forum-ID, zu der diese Konfiguration gehört.';
$string['privacy:metadata:local_forum_ai_config:reply_message'] = 'Vorlage für KI-generierte Antwort.';
...
$string['privacy:metadata:local_forum_ai_pending'] = 'Daten, die vom Forum-KI-Plugin gespeichert werden.';
$string['privacy:metadata:local_forum_ai_pending:approval_token'] = 'Zulassungstoken, das mit dem Beitrag verknüpft ist.';
...
$string['privacy:metadata:local_forum_ai_pending:message'] = 'Nachricht, die von künstlicher Intelligenz generiert wurde.';
...
$string['require_approval'] = 'KI-Überprüfung erforderlich';
