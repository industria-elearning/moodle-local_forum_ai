...
$string['default_reply_message'] = 'Отвечайте в эмпатичном и мотивирующем тоне';
...
$string['no'] = 'Нет';
$string['no_posts'] = 'Сообщения в этом обсуждении не найдены.';
$string['nohistory'] = 'Нет истории одобренных или отклонённых ответов ИИ.';
$string['nopermission'] = 'У вас нет прав для одобрения/отклонения ответов ИИ.';
$string['noresponses'] = 'Нет ответов, ожидающих одобрения.';
$string['originalmessage'] = 'Исходное сообщение';
$string['pendingresponses'] = 'Ответы форума ИИ в ожидании';
$string['pluginname'] = 'Форум ИИ';
$string['preview'] = 'Сообщение ИИ';
$string['reject'] = 'Отклонить';
$string['reply_message'] = 'Дать указания ИИ';
